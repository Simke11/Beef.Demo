...
namespace Beef.Demo.Common.Agents.ServiceAgents
{
    ...
    public partial class ReferenceDataServiceAgent : WebApiServiceAgentBase<ReferenceDataServiceAgent>, IReferenceDataServiceAgent
    {
        ...
        public Task<WebApiAgentResult<RefDataNamespace.GenderCollection>> GenderGetAllAsync(ReferenceDataFilter? args = null, WebApiRequestOptions? requestOptions = null) =>
            base.GetAsync<RefDataNamespace.GenderCollection>("api/v1/ref/genders", requestOptions: requestOptions, args: new WebApiArg[] { new WebApiArg<ReferenceDataFilter>("args", args!, WebApiArgType.FromUriUseProperties) });      
